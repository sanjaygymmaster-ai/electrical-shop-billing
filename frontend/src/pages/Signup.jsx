      ...
      <div className="w-full max-w-sm">
        ...
        {apiPointsToLocalhostOnProd && (
          <div className="mb-4 p-3 bg-amber-50 border-l-4 border-amber-400 text-amber-800 text-sm rounded">
            Warning: frontend is configured to use the local API (http://localhost). On Netlify this will fail — set <code>VITE_API_URL</code> in Netlify Site → Settings → Build & deploy → Environment to your backend URL (e.g. https://electrical-shop-backend.onrender.com).
          </div>
        )}
